 ...
 */
#ifndef RTW_HEADER_ControlSemCanalslx_h_
#define RTW_HEADER_ControlSemCanalslx_h_
#ifndef ControlSemCanalslx_COMMON_INCLUDES_
# define ControlSemCanalslx_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* ControlSemCanalslx_COMMON_INCLUDES_ */

#include "ControlSemCanalslx_types.h"
...
#define ControlSemCanalslx_rtModel     RT_MODEL_ControlSemCanalslx
...
typedef struct {
  ...
  real_T U;                            /* '<Root>/Sum6' */
  real_T U_d;                          /* '<Root>/Amplifier Voltage Limit' */
  real_T CableGain;                    /* '<S1>/Cable Gain' */
  real_T mtomm1[2];                    /* '<Root>/m to mm  1' */
...
typedef struct {
  ...
  t_task EncoderInput0CartPositionEnco_b;/* '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle' */
...
} D_Work_ControlSemCanalslx;

/* Backward compatible GRT Identifiers */
#define rtB                            ControlSemCanalslx_B
#define BlockIO                        BlockIO_ControlSemCanalslx
#define rtXdot                         ControlSemCanalslx_Xdot
#define StateDerivatives               StateDerivatives_ControlSemCana
#define tXdis                          ControlSemCanalslx_Xdis
#define StateDisabled                  StateDisabled_ControlSemCanalsl
#define rtP                            ControlSemCanalslx_P
#define Parameters                     Parameters_ControlSemCanalslx
#define rtDWork                        ControlSemCanalslx_DWork
#define D_Work                         D_Work_ControlSemCanalslx

/* Parameters (auto storage) */
struct Parameters_ControlSemCanalslx_ {
  ...
  real_T Step1_YFinal;                 /* Expression: 15
                                        * '<Root>/Step1'
                                        */
  real_T SquareWaveGenerator1_Amplitude;/* Expression: 15
                                         * '<Root>/Square Wave Generator1'
                                         */
  real_T SquareWaveGenerator1_Frequency;/* Expression: 0.5
                                         * '<Root>/Square Wave Generator1'
                                         */
  ...
  uint32_T HILInitialize_POChannels[8];/* Computed Parameter: POChannels
                                        * '<S1>/HIL Initialize'
                                        */
  uint32_T EncoderInput0CartPositionEnco_j[2];/* Computed Parameter: Channels
                                               * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                               */
  uint32_T EncoderInput0CartPositionEnco_e;/* Computed Parameter: SamplesInBuffer
                                            * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                            */
  ...
  boolean_T HILInitialize_DOFinal;     /* Computed Parameter: DOFinal
                                        * '<S1>/HIL Initialize'
                                        */
  boolean_T EncoderInput0CartPositionEnco_n;/* Computed Parameter: Active
                                             * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                             */
  boolean_T AnalogOutput0ToAmplifierDrivi_o;/* Computed Parameter: Active
                                             * '<S1>/Analog Output #0: To Amplifier Driving the Motor'
                                             */
};

/* Real-time Model Data Structure */
struct RT_MODEL_ControlSemCanalslx {
  const char_T *path;
...
extern Parameters_ControlSemCanalslx ControlSemCanalslx_P;

/* Block signals (auto storage) */
extern BlockIO_ControlSemCanalslx ControlSemCanalslx_B;

/* Block states (auto storage) */
extern D_Work_ControlSemCanalslx ControlSemCanalslx_DWork;

/* Model entry point functions */
extern void ControlSemCanalslx_initialize(boolean_T firstTime);
extern void ControlSemCanalslx_output(int_T tid);
extern void ControlSemCanalslx_update(int_T tid);
extern void ControlSemCanalslx_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ControlSemCanalslx *ControlSemCanalslx_M;
 ...
 *
 * '<Root>' : ControlSemCanalslx
 * '<S1>'   : ControlSemCanalslx/IP02
 * '<S2>'   : ControlSemCanalslx/Manual Switch
 * '<S3>'   : ControlSemCanalslx/IP02/Cart Position Watchdog
 * '<S4>'   : ControlSemCanalslx/IP02/Radians to Degrees
 * '<S5>'   : ControlSemCanalslx/IP02/Cart Position Watchdog/Stop with Message
 * '<S6>'   : ControlSemCanalslx/IP02/Cart Position Watchdog/Stop with Message1
 * '<S7>'   : ControlSemCanalslx/IP02/Cart Position Watchdog/Stop with Message/Compare
 * '<S8>'   : ControlSemCanalslx/IP02/Cart Position Watchdog/Stop with Message1/Compare
 */
#endif                                 /* RTW_HEADER_ControlSemCanalslx_h_ */
