...
Parameters_ControlSemCanalslx ControlSemCanalslx_P = {
  ...
  1000.0,                              /* mtomm_Gain : '<S1>/m to mm'
                                        */
  0.5,                                 /* Step1_Time : '<Root>/Step1'
                                        */
  0.0,                                 /* Step1_Y0 : '<Root>/Step1'
                                        */
  15.0,                                /* Step1_YFinal : '<Root>/Step1'
                                        */
  15.0,                                /* SquareWaveGenerator1_Amplitude : '<Root>/Square Wave Generator1'
                                        */
  0.5,                                 /* SquareWaveGenerator1_Frequency : '<Root>/Square Wave Generator1'
                                        */
