...
MODEL                = ControladorPI_LAB
MODULES              = ControladorPI_LAB_data.c ControladorPI_LAB_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = ControladorPI_LAB.mk
...
MODELLIB                  = ControladorPI_LABlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ControladorPI_LAB_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\Aluno\MEUSDO~1\MATLAB\Lab_CDig\LabFinal\CONTRO~3
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\Aluno\MEUSDO~1\MATLAB\Lab_CDig\LabFinal
