...
static void ControlSemCanalslx_output(int_T tid)
{
...

  {
    ...
    /* S-Function Block: ControlSemCanalslx/IP02/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_Sum9 = ControlSemCanalslx_DWork.EncoderInput0CartPositionEncode[0];
        rtb_U = ControlSemCanalslx_DWork.EncoderInput0CartPositionEncode[1];
      }
    }

    /* Gain: '<S1>/Conversion to m' */
    rtb_Conversiontom = ControlSemCanalslx_P.Conversiontom_Gain * rtb_Sum9;
     ...
     */
    rtb_Gain12[0] = ControlSemCanalslx_DWork.Delay3_X[0];
    rtb_Gain12[1] = ControlSemCanalslx_DWork.Delay3_X[1];

    /* Gain: '<Root>/Gain2' */
    ControlSemCanalslx_B.Gain2 = ControlSemCanalslx_P.Gain2_Gain[0] *
      rtb_Gain12[0] + ControlSemCanalslx_P.Gain2_Gain[1] * rtb_Gain12[1];

    /* Sum: '<Root>/Sum6' */
    ControlSemCanalslx_B.U = currentTime - ControlSemCanalslx_B.Gain2;

    /* Saturate: '<Root>/Amplifier Voltage Limit' */
    rtb_U = rt_SATURATE(ControlSemCanalslx_B.U,
    ...
    rtb_Sum9 = ControlSemCanalslx_P.CableGainPreCompensation_Gain * rtb_U;
    ...
    /* Gain: '<S1>/Cable Gain' */
    rtb_Sum9 *= ControlSemCanalslx_P.CableGain_Gain;

    /* Scope: '<S1>/V Command (V)' */
    {
      real_T u[2];
      u[0] = ControlSemCanalslx_M->Timing.t[1];
      u[1] = rtb_Sum9;
      rt_UpdateLogVar((LogVar *)
                      ControlSemCanalslx_DWork.VCommandV_PWORK.LoggedData, u, 0);
    }

    /* Gain: '<Root>/Gain13' */
    rtb_Sum9 = ControlSemCanalslx_P.Gain13_Gain[0] * rtb_Gain12[0] +
      ControlSemCanalslx_P.Gain13_Gain[1] * rtb_Gain12[1];

    /* Gain: '<Root>/m to mm  1' */
    rtb_Gain10[0] = ControlSemCanalslx_P.mtomm1_Gain * rtb_Conversiontom;
    rtb_Gain10[1] = ControlSemCanalslx_P.mtomm1_Gain * rtb_Sum9;
    ...
    /* Gain: '<Root>/Gain10' */
    rtb_Gain10[0] = ControlSemCanalslx_P.Gain10_Gain[0] * rtb_Sum9;

    /* Gain: '<Root>/Gain11' */
    rtb_Conversiontom = ControlSemCanalslx_P.Gain11_Gain[0] * rtb_Gain12[0] +
      ControlSemCanalslx_P.Gain11_Gain[2] * rtb_Gain12[1];

    /* Gain: '<Root>/Gain10' */
    rtb_Gain10[1] = ControlSemCanalslx_P.Gain10_Gain[1] * rtb_Sum9;

    /* Gain: '<Root>/Gain11' */
    currentTime = ControlSemCanalslx_P.Gain11_Gain[1] * rtb_Gain12[0] +
      ControlSemCanalslx_P.Gain11_Gain[3] * rtb_Gain12[1];

    /* Gain: '<Root>/Gain12' */
    rtb_Gain12[0] = ControlSemCanalslx_P.Gain12_Gain[0] * rtb_U;

    /* Sum: '<Root>/Sum7' */
    ControlSemCanalslx_B.xk1[0] = (rtb_Gain10[0] + rtb_Gain12[0]) +
      rtb_Conversiontom;

    /* Gain: '<Root>/Gain12' */
    rtb_Gain12[1] = ControlSemCanalslx_P.Gain12_Gain[1] * rtb_U;

    /* Sum: '<Root>/Sum7' */
    ControlSemCanalslx_B.xk1[1] = (rtb_Gain10[1] + rtb_Gain12[1]) + currentTime;
  }
...
static void ControlSemCanalslx_update(int_T tid)
{
  /* Integer/Tapped Delay Block: '<Root>/Delay3'
   */
...
void ControlSemCanalslx_initialize(boolean_T firstTime)
{
  ...
  rtmSetTFinal(ControlSemCanalslx_M, 4.9920000000000009E+000);
  ...
  /* Setup for data logging */
  {
    ...
    ControlSemCanalslx_M->rtwLogInfo = &rt_DataLoggingInfo;
    rtliSetLogXSignalInfo(ControlSemCanalslx_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(ControlSemCanalslx_M->rtwLogInfo, (NULL));
    rtliSetLogT(ControlSemCanalslx_M->rtwLogInfo, "tout");
    rtliSetLogX(ControlSemCanalslx_M->rtwLogInfo, "");
    rtliSetLogXFinal(ControlSemCanalslx_M->rtwLogInfo, "");
    rtliSetSigLog(ControlSemCanalslx_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(ControlSemCanalslx_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(ControlSemCanalslx_M->rtwLogInfo, 2);
    rtliSetLogMaxRows(ControlSemCanalslx_M->rtwLogInfo, 0);
    rtliSetLogDecimation(ControlSemCanalslx_M->rtwLogInfo, 1);
    rtliSetLogY(ControlSemCanalslx_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(ControlSemCanalslx_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(ControlSemCanalslx_M->rtwLogInfo, (NULL));
  }
...
void MdlInitializeSizes(void)
{
  ...
  ControlSemCanalslx_M->Sizes.numBlocks = (43);/* Number of blocks */
  ControlSemCanalslx_M->Sizes.numBlockIO = (5);/* Number of block outputs */
  ControlSemCanalslx_M->Sizes.numBlockPrms = (142);/* Sum of parameter "widths" */
}
...
void MdlStart(void)
{
  ...
  /* Scope Block: '<S1>/V Command (V)' */
  {
    int_T numCols = 2;
    ControlSemCanalslx_DWork.VCommandV_PWORK.LoggedData = rt_CreateLogVar(
      ControlSemCanalslx_M->rtwLogInfo,
      rtmGetTFinal(ControlSemCanalslx_M),
      ControlSemCanalslx_M->Timing.stepSize0,
      (&rtmGetErrorStatus(ControlSemCanalslx_M)),
      "data_vm",
      SS_DOUBLE,
      0,
      0,
      ...
      1.3000000000000001E-002,
      1);
    if (ControlSemCanalslx_DWork.VCommandV_PWORK.LoggedData == (NULL))
      return;
  }
  ...
  /* ToWorkspace Block: '<Root>/To Workspace' */
  {
    ...
    static const char_T rt_ToWksBlockName[] = "ControlSemCanalslx/To Workspace";
    ControlSemCanalslx_DWork.ToWorkspace_PWORK.LoggedData =
      ...
      &rt_ToWksSignalInfo,
      rt_ToWksBlockName);
    if (ControlSemCanalslx_DWork.ToWorkspace_PWORK.LoggedData == (NULL))
      return;
  }
  ...
  /* ToWorkspace Block: '<Root>/To Workspace1' */
  {
    ...
    static const char_T rt_ToWksBlockName[] = "ControlSemCanalslx/To Workspace1";
    ControlSemCanalslx_DWork.ToWorkspace1_PWORK.LoggedData =
      rt_CreateStructLogVar(
      ControlSemCanalslx_M->rtwLogInfo,
      rtmGetTFinal(ControlSemCanalslx_M),
      ...
      &rt_ToWksSignalInfo,
      rt_ToWksBlockName);
    if (ControlSemCanalslx_DWork.ToWorkspace1_PWORK.LoggedData == (NULL))
      return;
  }
  ...
  /* ToWorkspace Block: '<Root>/To Workspace2' */
  {
    ...
    static const char_T *rt_ToWksLabels[] = { "x(k)" };
    ...
    static const char_T rt_ToWksBlockName[] = "ControlSemCanalslx/To Workspace2";
    ControlSemCanalslx_DWork.ToWorkspace2_PWORK.LoggedData =
      rt_CreateStructLogVar(
      ControlSemCanalslx_M->rtwLogInfo,
      rtmGetTFinal(ControlSemCanalslx_M),
      ...
      &rt_ToWksSignalInfo,
      rt_ToWksBlockName);
    if (ControlSemCanalslx_DWork.ToWorkspace2_PWORK.LoggedData == (NULL))
      return;
  }
