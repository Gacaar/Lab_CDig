 ...
 */
#ifndef RTW_HEADER_so_observador_h_
#define RTW_HEADER_so_observador_h_
#ifndef so_observador_COMMON_INCLUDES_
# define so_observador_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* so_observador_COMMON_INCLUDES_ */

#include "so_observador_types.h"
...
#define so_observador_rtModel          RT_MODEL_so_observador
...
typedef struct {
  ...
  real_T xk[2];                        /* '<Root>/Delay1' */
  real_T mtomm_n;                      /* '<Root>/m to mm' */
  real_T Gain9;                        /* '<Root>/Gain9' */
  real_T xk1[2];                       /* '<Root>/Sum2' */
  boolean_T CheckMaximumAllowedPosition;/* '<S2>/Check Maximum Allowed Position' */
  boolean_T CheckMinimumAllowedPosition;/* '<S2>/Check Minimum Allowed Position' */
} BlockIO_so_observador;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T Delay1_X[2];                  /* '<Root>/Delay1' */
  ...
  struct {
    void *LoggedData;
  } Controle_PWORK;                    /* '<Root>/Controle' */

  struct {
    void *LoggedData;
  } Estados_PWORK;                     /* '<Root>/Estados' */

  struct {
    void *LoggedData;
  } Saidas_PWORK;                      /* '<Root>/Saidas' */
  ...
  struct {
    void *LoggedData;
  } ToWorkspaceSistemaReal1_PWORK;     /* '<Root>/To Workspace Sistema Real1' */

  struct {
    void *LoggedData;
  } ToWorkspaceSistemaReal2_PWORK;     /* '<Root>/To Workspace Sistema Real2' */
  ...
  t_task EncoderInput0CartPositionEnco_o;/* '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle' */
...
} D_Work_so_observador;

/* Backward compatible GRT Identifiers */
#define rtB                            so_observador_B
#define BlockIO                        BlockIO_so_observador
#define rtXdot                         so_observador_Xdot
#define StateDerivatives               StateDerivatives_so_observador
#define tXdis                          so_observador_Xdis
#define StateDisabled                  StateDisabled_so_observador
#define rtP                            so_observador_P
#define Parameters                     Parameters_so_observador
#define rtDWork                        so_observador_DWork
#define D_Work                         D_Work_so_observador

/* Parameters (auto storage) */
struct Parameters_so_observador_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 15
                                        * '<Root>/Step'
                                        */
  ...
  real_T CableGain_Gain;               /* Expression:  K_AMP
                                        * '<S1>/Cable Gain'
                                        */
  real_T Delay1_InitialCondition;      /* Expression: vinit
                                        * '<Root>/Delay1'
                                        */
  real_T mtomm_Gain_b;                 /* Expression: 1e3
                                        * '<Root>/m to mm'
                                        */
  real_T Gain9_Gain[2];                /* Expression: C
                                        * '<Root>/Gain9'
                                        */
  real_T Gain5_Gain[2];                /* Expression: L
                                        * '<Root>/Gain5'
                                        */
  real_T Gain7_Gain[4];                /* Expression: G
                                        * '<Root>/Gain7'
                                        */
  real_T Gain8_Gain[2];                /* Expression: H
                                        * '<Root>/Gain8'
                                        */
  ...
  uint32_T HILInitialize_POChannels[8];/* Computed Parameter: POChannels
                                        * '<S1>/HIL Initialize'
                                        */
  uint32_T EncoderInput0CartPositionEnco_h[2];/* Computed Parameter: Channels
                                               * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                               */
  uint32_T EncoderInput0CartPositionEnco_n;/* Computed Parameter: SamplesInBuffer
                                            * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                            */
  ...
  int8_T ShowMessageonHost_MsgIcon;    /* Computed Parameter: MsgIcon
                                        * '<S4>/Show Message on Host'
                                        */
  int8_T ShowMessageonHost_MsgIcon_j;  /* Computed Parameter: MsgIcon
  ...
  boolean_T HILInitialize_DOFinal;     /* Computed Parameter: DOFinal
                                        * '<S1>/HIL Initialize'
                                        */
  boolean_T EncoderInput0CartPositionEnc_hf;/* Computed Parameter: Active
                                             * '<S1>/Encoder Input #0: Cart Position Encoder Input #1: Pendulum Angle'
                                             */
  boolean_T AnalogOutput0ToAmplifierDrivi_b;/* Computed Parameter: Active
                                             * '<S1>/Analog Output #0: To Amplifier Driving the Motor'
                                             */
};

/* Real-time Model Data Structure */
struct RT_MODEL_so_observador {
  const char_T *path;
...
extern Parameters_so_observador so_observador_P;

/* Block signals (auto storage) */
extern BlockIO_so_observador so_observador_B;

/* Block states (auto storage) */
extern D_Work_so_observador so_observador_DWork;

/* Model entry point functions */
extern void so_observador_initialize(boolean_T firstTime);
extern void so_observador_output(int_T tid);
extern void so_observador_update(int_T tid);
extern void so_observador_terminate(void);

/* Real-time Model object */
extern RT_MODEL_so_observador *so_observador_M;
 ...
 *
 * '<Root>' : so_observador
 * '<S1>'   : so_observador/IP02
 * '<S2>'   : so_observador/IP02/Cart Position Watchdog
 * '<S3>'   : so_observador/IP02/Radians to Degrees
 * '<S4>'   : so_observador/IP02/Cart Position Watchdog/Stop with Message
 * '<S5>'   : so_observador/IP02/Cart Position Watchdog/Stop with Message1
 * '<S6>'   : so_observador/IP02/Cart Position Watchdog/Stop with Message/Compare
 * '<S7>'   : so_observador/IP02/Cart Position Watchdog/Stop with Message1/Compare
 */
#endif                                 /* RTW_HEADER_so_observador_h_ */
